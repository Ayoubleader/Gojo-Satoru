...
「اضغط هنا اذا موافق 😂🤡」◣`
	    ...
	    「 زوجناكم لأنكم تصلحون لبعض 🤡 」◣
	    「 الي يشوفهم مناسبين لبعض مثلي يضغط يب 🤡 」◣`
            let menst = [orang, jodoh]
            let buttons = [
                        { buttonId: '「 نعم هه هم مناسبين لبعض😂🤡 」◣', buttonText: { displayText: '「 يب هم مناسبين لبعض😂🤡 」◣' }, type: 1 }
                    ]
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
 ...
 「 رابط محادثة صانع البوت」◣
		    「https://wa.me/+212690943590?text=بــــاش♕ناجوطـــيك」◣
		    「 💖」◣                 
 「 رابط مجموعة قصص و أقتباسات تابعة لمالك البوت」◣
		    「*https://chat.whatsapp.com/C0Q2cM8pyvOCPImLQplTlz*」◣
		    「 أتمنى أن تعجبكم」◣`,
                    ...
                    sections: [{
							...
							},
							{
								...
								"rows": [
									{
										"title": "قائمة استمارات مملكة هارت",
										"description": ".17.",
										"rowId": `${prefix}anon`
									}
								]
...
「 _https://chat.whatsapp.com/K2ATZYqajubL2NJoh8YyXM_ 」◣
...
await GojoMdNx.send5ButImg(from, `` + '' + ' مملكة هارت ، مملكة جديدة سوف تصعد بمساعدتكم.`,unicorn, [{"urlButton": {"displayText": "「 قناتي 」「📍」◣","url": `${myweb}`}},{"urlButton": {"displayText": "「 رابط الاستقبال 」「📌」◣","url": `${sc}`}},{"quickReplyButton": {"displayText": "「 الاستلام 」「🍜」◣","id": 'donate'}},{"quickReplyButton": {"displayText": "「 المالك 」「👤」◣","id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
